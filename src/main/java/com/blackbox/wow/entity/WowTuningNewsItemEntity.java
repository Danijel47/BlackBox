...
public class WowTuningNewsItemEntity {
    ...
    public boolean hasNewPublication(String newTitle, Instant newPublishedAt) {
        return newPublishedAt.isAfter(publishedAt) && !title.equals(newTitle);
    }

    public void recordNotification(String newTitle, String newUrl, Instant newPublishedAt, Instant now) {
        title = newTitle;
        url = newUrl;
